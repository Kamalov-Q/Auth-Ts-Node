...
function connectDB() {
    return __awaiter(this, void 0, void 0, function () {
        var MONGODB_URL, existingAdmin, hashedPassword, adminUser, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, users_model_1.User.findOne({ email: "kamalov@gmail.com" })];
                case 2:
                    existingAdmin = _a.sent();
                    if (!existingAdmin) return [3 /*break*/, 3];
                    console.log("Admin already exists!");
                    return [3 /*break*/, 6];
                case 3: return [4 /*yield*/, (0, hash_1.hashPassword)("test")];
                case 4:
                    hashedPassword = _a.sent();
                    adminUser = new users_model_1.User({
                        name: "Admin",
